          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`enterprise-input pl-12 relative z-0 ${validationErrors.mobile ? 'error' : ''} ${
                journeyType === "etb" || journeyType === "etb-nk" || journeyType === "ntb" || journeyType === "ntb-lite"
                  ? "bg-gray-100 text-gray-500 cursor-not-allowed"
                  : ""
              }`}
              placeholder="98765 43210"
              autoFocus
              disabled={otpSent || journeyType === "etb" || journeyType === "etb-nk" || journeyType === "ntb" || journeyType === "ntb-lite"}
            />
          </div>
